...
namespace Raycaster
{
    public class GenerateSpheres
    {
        ...
        public GenerateSpheres()
        {
            ...
            sphereList.Add(new Sphere(new Vector3(1f, 6f, 11f), 0.7f));
            ...
            sphereList.Add(new Sphere(new Vector3(0f, 0f, 00f), 1.3f));
            sphereList.Add(new Sphere(new Vector3(8f, 4f, 00f), 0.1f));
            ...
            sphereList.Add(new Sphere(new Vector3(9f, 2f, 01f), 0.5f));
            ...
            sphereList.Add(new Sphere(new Vector3(0f, 0f, 00f), 1.4f));
            sphereList.Add(new Sphere(new Vector3(1f, 7f, 00f), 1.7f));
            ...
            sphereList.Add(new Sphere(new Vector3(1f, 9f, 23f), 1.9f));
            ...
            sphereList.Add(new Sphere(new Vector3(8f, 4f, 15f), 1.5f));
            ...
            sphereList.Add(new Sphere(new Vector3(1f, 4f, 04f), 0.6f));
            ...
            sphereList.Add(new Sphere(new Vector3(5f, 4f, 00f), 0.5f));
            ...
            sphereList.Add(new Sphere(new Vector3(3f, 3f, 00f), 0.3f));
